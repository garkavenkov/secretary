<template>
    ...
    <Widget>
        ...
        Кількість іменинніків у {{ monthNames[month-1]}}
...
export default {
    ...
    created() {
        axios
            .get(`api/v1/household-members-birthday-in-month/${this.month}`)
            .then(res => this.totalCount = res.data);
    }
}
