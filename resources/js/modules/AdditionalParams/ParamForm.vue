<template>
    ...
    <ModalForm formId="ParamForm" @submitData="submitData" @closeForm="closeForm" :sumbitIsDisabled="!readyFodSubmit">
        ...
        <div class="row mb-3">
            <div class="col">
                <label for="paramValueType" class="form-label">Тип значення</label>
                <select :class="['form-control', hasError('value_type_id') ? 'is-invalid' : '']"
                        id="paramValueType"
                        v-model="formData.value_type_id">
                    <option disabled value="0">Оберіть тип значення</option>
