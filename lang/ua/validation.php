...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'email' => [
            'required'  => 'Ви не указали адресу елєктронної пошти',
            'email'     => 'Укажіть дійсну адресу електронної пошти',
        ],
        'description' => [
        ...
        'password'    => [
            'required'  => 'Ви не указали пароль',
            'min'       => 'Укажіть не менше ніж :min символів',
